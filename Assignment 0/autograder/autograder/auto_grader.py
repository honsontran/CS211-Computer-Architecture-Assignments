...
if __name__ == '__main__':
    ...
    if tarmode==False:
        if not os.path.isdir(basepath):
            print "PA0 is not present in this directory."
            sys.exit(1)
        else:
            print "Grading the content of PA0."
            os.chdir(basepath)
	...
	print "dir is ", prevdir
        if not os.path.exists("PA0.tar"):
            print "Expecting PA0.tar in current directory. Current directory is %s"%(prevdir)
            print "Please make sure you created PA0.tar in the right directory"
            sys.exit(1)
        ...
        os.chdir("obj_temp")
        run_command("tar -xvf ../PA0.tar")
        if os.path.isdir("PA0"):
            os.chdir("PA0")
            global_grade("PA0")
        else:
            print "There is not directory named PA0 in PA0.tar."
